 ...
 * Class GeraBoleto
 * @version   0.0.1
 * @author    Erick R. Alves Aguiar <erick@beontop.com.br>
 * @copyright Beontop Serviços Digitais
 */
 ...
 * 
 * <b>O que ela faz?</b>
 * Responsável por monstar os calculos necessários e gerar o boleto.
 * 
...
class BoletoBradesco
{
    ...
    /**
     * Calcula o digito de auto-conferência do nosso número e codigo de barras
     *
     * @access private
     * @param string $num - Número para calcular
	...
	/**
     * Gera o nosso número usando o metodo modulo11 com base 7
     *
     * @access private
     */
    private function geraNossoNum()
    {
     ...
     * @access private
     */
    private function digitoCodigoBarras()
    {
        /**
    ...
    /**
     * Concatena os números do código de barras com o digito do mesmo
     *
     * @access public
     */
     ...
     * @access private
     */
    private function formataLinhaDigitavel()
    {
        $format = "";
     ...
     * @access private
     */
    private function fatorVencimento()
    {
    ...
    /**
     * Monta o código de barrar. Retorna um array com o tipo de barra que deve ser mostrado.
     * Ep (barra Estreita preta) - Eb (barra Estreita branca) - Lp (barra Larga preta) - Lb (barra Larga branca)
     *
     * @access public
     * @param  
     */
