<?php
	...
	function conection() {
		$connect = mysql_connect("sistemaeds.com.br", "sistemae_sistema", "Lqll.Su#^sJ6");
		$selectDb = mysql_select_db("sistemae_sistema") or die (mysql_error());
	...
	function select($query) {
		...
		if($result) {
			while ($data = mysql_fetch_array($result)) {
				...
				echo $data['nome'] . ", id " . $data['id'];
			}
		}
		else {
			echo "Erro ao selecionar tabela do banco";
		}
	}
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="index.html#section2" onclick="window.location = this.href">Serviços</a></li>
						<li><a href="index.html#section3" onclick="window.location = this.href">Infos</a></li>
						<li><a href="index.html#section4" onclick="window.location = this.href">Clientes</a></li>
						<li><a href="index.html#section6" onclick="window.location = this.href">Preços</a></li>
						<li><a href="index.html#section7" onclick="window.location = this.href">FAQ</a></li>
		...
		<div class="container" id="Cadastro">
				<div class="row">				
					<div class="contFrm">
							...
							<form id="contactform" action="send.php" method="post" enctype="multipart/form-data">	
								...
								<div class="col-md-8 col-md-offset-2">
									<div class="col-md-12 text-right">
										...
										<div class="col-md-6 text-right">
											...
											<input type="text" name="usuario_email" id="usuario_email" placeholder="E-mail">
										</div>
										<div class="col-md-6 text-right">
											<input type="password" name="usuario_senha" id="usuario_senha" placeholder="Senha">
										</div>
										<div class="col-md-6 text-left">
											<select name="usuario_genero_id" id="usuario_genero_id">
										...
										<div class="col-md-6 text-right">
											<input type="text" name="entidade_numero" id="entidade_numero" placeholder="CPF">
										</div>
										<div class="col-md-6 text-left">
											<input type="text" name="entidade_endereco" id="entidade_endereco" placeholder="Endereço do seu EVS">
										</div>
										<div class="col-md-6 text-right">
											<input type="text" name="entidade_bairro" id="entidade_bairro" placeholder="Bairro">
										</div>
										<div class="col-md-6 text-left">
										...
										<div class="col-md-6 text-right">
											<select name="cidade" id="cidade">
												<option>Cidade - selecione um estado</option>
											</select>
										</div>
									</div>
								...
								<div class="col-md-8 text-center col-md-offset-2">
									<div class="col-md-12">
										<div class="col-md-12">
											<fieldset class="forma-pagamento col-md-12">
												<strong>Foto do anfitrião:</strong>
												<br><br>
												<div class="col-md-9">
													<input type="file" name="usuario_foto" id="usuario_foto">
													<div class="button button-select-img">Selecionar foto</div>
												</div>
												<div class="col-md-3">
													<div id="beforeSelectImg"></div>
												</div>
												<div class="clear-fix"></div>
											</fieldset>
											...
											<fieldset class="forma-pagamento col-md-12">
												...
												<br><br>
												<div class="col-md-6">
													<input type="radio" name="plano" value="0" class="radio" id="radio-plano-0" checked>
													<label for="radio-plano-0">1º mês gratuito</label>
												</div>
												<div class="col-md-6">
													<input type="radio" name="plano" value="1" class="radio" id="radio-plano-1">
													<label for="radio-plano-1">29,90 /Mês</label>
												</div>
												<div class="col-md-6">
													<input type="radio" name="plano" value="2" class="radio" id="radio-plano-2">
													<label for="radio-plano-2">R$229,90 /Ano</label>
												</div>
												<div class="clear-fix"></div>
											</fieldset>
											...
											<!--fieldset class="forma-pagamento col-md-12">
												...
												<br><br>
												<div class="col-md-6">
													<input type="radio" name="pagamento[tipo]" value="boleto" class="radio" id="radio-boleto">
													<label for="radio-boleto">Boleto Bancário</label>
												</div>
												<div class="col-md-6">
													<input type="radio" name="pagamento[tipo]" value="cartao" class="radio" id="radio-cartao">
													<label for="radio-cartao">Cartão de Crédito</label>
												</div>
												<div class="clear-fix"></div>
											</fieldset-->
											<fieldset class="col-md-12">
												<div class="col-md-12">
													<label>
														<span id="termos_alert">Você precisa ler e aceitar os termos de uso.</span><br>
														<input type="checkbox" name="termos" value="aceito" class="radio" id="termos">
														Eu li e aceito os <a href="termos.php" target="_blank">termos de uso</a>.
													</label>
												</div>
												<div class="clear-fix"></div>
											</fieldset>
											<div class="col-md-10 col-md-offset-1">
												<input type="submit" value="Completar pedido" class="button">
											</div>
										</div>
									</div>
								</div>
